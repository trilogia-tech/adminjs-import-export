...
import { ExporterType } from './export/export.type.js'
...
export type Importer = (records: string, resource: BaseResource) => Promise<BaseRecord[]>

export const Parsers: Record<ExporterType, { export: Exporter; import: Importer }> = {
